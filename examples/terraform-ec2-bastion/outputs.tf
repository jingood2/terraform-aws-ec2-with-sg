...
output "public_bastion_sg_group_id" {
  ...
  value       = module.ec2-bastion.public_bastion_sg_group_id
}

## public_bastion_sg_group_vpc_id
output "public_bastion_sg_group_vpc_id" {
  description = "The VPC ID"
  value       = module.ec2-bastion.public_bastion_sg_group_vpc_id
}

## public_bastion_sg_group_name
output "public_bastion_sg_group_name" {
  description = "The name of the security group"
  value       = module.ec2-bastion.public_bastion_sg_group_name
}
...
output "private_key" {
  value     = module.ec2-bastion.private_key
  sensitive = true
}